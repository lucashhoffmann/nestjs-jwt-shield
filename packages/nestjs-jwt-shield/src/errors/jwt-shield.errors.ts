...
export class JwtShieldInvalidImpersonationError extends JwtShieldError {
  constructor(message = "Impersonation token is invalid.", cause?: unknown) {
    super(message, "JWT_SHIELD_INVALID_IMPERSONATION", cause);
  }
}
